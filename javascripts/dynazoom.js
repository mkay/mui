function refreshZoom(query, form, image, divOverlay) {
  ...
  function click(event) {
    switch ((clickCounter++) % 2) {
      case 0: 
        startZoom(event);
        document.getElementById("hint-start").classList.add("done");
        document.getElementById("hint-stop").classList.remove("sr-only");
        // document.getElementById("img-overlay").classList.remove("hidden");
        break;
      case 1: 
        endZoom(event);
        document.getElementById("hint-stop").classList.add("done");
        document.getElementById("hint-zoom").classList.remove("sr-only");
        break;			
    }
  }
